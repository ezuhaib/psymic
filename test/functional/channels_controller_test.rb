...
class ChannelsControllerTest < ActionController::TestCase
  ...
  test "should create channel" do
    assert_difference('Channel.count') do
      post :create, channel: { body: @channel.body, slug: @channel.slug, source: @channel.source, title: @channel.title }
    end
  ...
  test "should update channel" do
    put :update, id: @channel, channel: { body: @channel.body, slug: @channel.slug, source: @channel.source, title: @channel.title }
    assert_redirected_to channel_path(assigns(:channel))
  end
