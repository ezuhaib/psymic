...
class WikiPagesControllerTest < ActionController::TestCase
  ...
  test "should create wiki_page" do
    assert_difference('WikiPage.count') do
      post :create, wiki_page: { body: @wiki_page.body, title: @wiki_page.title, user_id: @wiki_page.user_id }
    end
  ...
  test "should update wiki_page" do
    put :update, id: @wiki_page, wiki_page: { body: @wiki_page.body, title: @wiki_page.title, user_id: @wiki_page.user_id }
    assert_redirected_to wiki_page_path(assigns(:wiki_page))
  end
