...
class ComicsControllerTest < ActionController::TestCase
  ...
  test "should create comic" do
    assert_difference('Comic.count') do
      post :create, comic: { caption: @comic.caption, likes_count: @comic.likes_count, mindlog_id: @comic.mindlog_id, user_id: @comic.user_id }
    end
  ...
  test "should update comic" do
    put :update, id: @comic, comic: { caption: @comic.caption, likes_count: @comic.likes_count, mindlog_id: @comic.mindlog_id, user_id: @comic.user_id }
    assert_redirected_to comic_path(assigns(:comic))
  end
